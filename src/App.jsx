...
function AboutUs() {
  return (
    <div className="flex flex-col gap-y-16 self-stretch p-0 md:px-36 pb-16">
      <div className="main-about flex flex-row gap-y-6 self-stretch bg-white rounded-2xl">
        <div className="about-half w-[50%] p-[2rem] rounded-l-2xl">
